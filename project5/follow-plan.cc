...
{  
  ...
  while(!arrived) 
    {   
      ...
      if(x_des - pose.px < 0.1 && y_des - pose.py < 0.1){
        std::cout << "arrived at x = " << x_des << ", y = " << y_des << std::endl; 
        next_dest += 2;
        x_des = plan[next_dest];
        y_des = plan[next_dest + 1];
        std::cout << "updated my next destination to x = " << x_des << ", y = " << y_des << std::endl;
      }
...
/*
    ...
    */
      ...
      std::cout << "pose.py: " << pose.py << std::endl << std::endl;

      std::cout << "theta: " << theta << std::endl; 
      std::cout << "theta in degrees: " << theta * 180 / 3.14 << std::endl;
      std::cout << "pose.pa: " << pose.pa << std::endl;
      std::cout << "pose.pa in degrees: " << pose.pa * 180 / 3.14 << std::endl << std::endl;
